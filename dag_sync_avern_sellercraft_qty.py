...
with DAG(
    ...
    def run() -> None:
        ...
        try:
            ...
            access_token = Variable.get("AVERN_ACCESS_TOKEN")
            sellercraft_id = Variable.get("AVERN_SELLERCRAFT_ID")
            fulfillment_center_id = Variable.get("AVERN_FULFILLMENT_CENTER_ID")
